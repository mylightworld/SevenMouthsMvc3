...
namespace SevenMouths.Models
{
    ...
    public partial class SharePicture: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public int PictureId
        {
            ...
            set
            {
                if (_pictureId != value)
                {
                    if (ChangeTracker.ChangeTrackingEnabled && ChangeTracker.State != ObjectState.Added)
                    {
                        throw new InvalidOperationException("The property 'PictureId' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _pictureId = value;
